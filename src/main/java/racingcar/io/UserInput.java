...
public class UserInput {
    ...
    public static RacingParticipantsRequest participants() {
        return RacingParticipantsRequest.from(inputFrom(GuideMessage.FOR_RACING_CAR_NAMES));
    }

    public static RacingLapCountRequest tryingCount() {
        return RacingLapCountRequest.from(inputFrom(GuideMessage.FOR_TRYING_COUNT));
    }
